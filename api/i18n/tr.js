module.exports = {
    "SYSTEM": {
        "ERROR": "Sistem Hatası",
        "ERROR_DESCRIPTION": "İsteğiniz işlenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin."
    },
    "COMMON": {
        "VALIDATION_ERROR": "Doğrulama Hatası",
        "VALIDATION_ERROR_DESCRIPTION": "Yaptığınız istek geçersiz. Lütfen isteğinizi kontrol edip tekrar deneyin.",
        "NOT_FOUND": "Bulunamadı",
        "NOT_FOUND_DESCRIPTION": "Aradığınız kaynak mevcut değil.",
        "UNAUTHORIZED": "Yetkisiz",
        "UNAUTHORIZED_DESCRIPTION": "Bu kaynağa erişim yetkiniz yok.",
        "FORBIDDEN": "Erişim Engellendi",
        "FORBIDDEN_DESCRIPTION": "Bu kaynağa erişmenize izin verilmiyor.",
    ...
    "USERS": {
        ...
        "USER_NOT_FOUND_DESCRIPTION": "Aradığınız kullanıcı mevcut değil.",
        "EMAIL_REQUIRED": "E-posta alanı zorunludur",
        "FIRST_NAME_REQUIRED": "Ad alanı zorunludur",
        "LAST_NAME_REQUIRED": "Soyad alanı zorunludur",
        "PHONE_NUMBER_REQUIRED": "Telefon numarası zorunludur",
        "PASSWORD_REQUIRED": "Parola alanı zorunludur",
        "PASSWORD_MIN_LENGTH": "Parola en az {0} karakter uzunluğunda olmalıdır",
        "ROLES_REQUIRED": "Roller zorunludur",
        "ROLES_NOT_FOUND": "Bir veya daha fazla rol bulunamadı",
